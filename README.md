...
The script `flashimage.py` will build the netinstaller image from downloaded debian packages and flash it onto your SD card. Run the script and follow the instructions:
